...
class ObservableEntityPropertySet(ConfiguredBaseModel):
    ...
    observable_property_id_list: Optional[List[str]] = Field(default=None)
...
class QuestionnaireResult(ObservationResult):
    registration_start_date: Optional[date] = Field(default=None)
    registration_end_date: Optional[date] = Field(default=None)
    observation_result_type: Optional[ObservationResultType] = Field(default=None)
    observation_start_date: Optional[date] = Field(default=None)
    observation_end_date: Optional[date] = Field(default=None)
    observed_values: Optional[List[ObservedValue]] = Field(default=None)
...
class SamplingResult(ObservationResult):
    collection_start_date: Optional[date] = Field(default=None)
    collection_end_date: Optional[date] = Field(default=None)
    analysis_start_date: Optional[date] = Field(default=None)
    analysis_end_date: Optional[date] = Field(default=None)
    analysis_lab: Optional[str] = Field(default=None)
    observation_result_type: Optional[ObservationResultType] = Field(default=None)
    observation_start_date: Optional[date] = Field(default=None)
    observation_end_date: Optional[date] = Field(default=None)
    observed_values: Optional[List[ObservedValue]] = Field(default=None)
