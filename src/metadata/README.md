 ...
 * [parco-hbm.yml](parco-hbm.yml)
     * Determines how your purl.obolibrary.org/obo/parco-hbm/ redirects will be handled
     ...
     * Paste in the contents of [parco-hbm.yml](parco-hbm.yml)
 ...
 * [parco-hbm.md](parco-hbm.md)
     ...
     * Paste in the contents of [parco-hbm.md](parco-hbm.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
